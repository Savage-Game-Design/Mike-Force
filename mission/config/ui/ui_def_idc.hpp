...
#include "taskroster\requests\idc.hpp"
...
#define VN_TR_TABPROFILE_IDC				412012
#define VN_TR_TABPROFILE_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_TABPROFILE_IDC)
#define VN_TR_TABREQUESTS_IDC				412013
#define VN_TR_TABREQUESTS_CTRL				(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_TABREQUESTS_IDC)
#define VN_TR_TABTASKS_IDC					412014
#define VN_TR_TABTASKS_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_TABTASKS_IDC)
#define VN_TR_TABS_CTRLS					[VN_TR_TABPROFILE_CTRL, VN_TR_TABREQUESTS_CTRL, VN_TR_TABTASKS_CTRL]

#define VN_TR_REQUESTS_IDC					415000
#define VN_TR_REQUESTS_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_REQUESTS_IDC)

#define VN_TR_TASKS_IDC						416000
#define VN_TR_TASKS_CTRL					(VN_DISP_TR_TASKROSTER displayCtrl VN_TR_TASKS_IDC)
#define VN_TR_TASKS_TREEMAINTASKLIST_IDC	416001
#define VN_TR_TASKS_TREEMAINTASKLIST_CTRL	(VN_TR_TASKS_CTRL controlsGroupCtrl VN_TR_TASKS_TREEMAINTASKLIST_IDC)
#define VN_TR_TASKS_SUPPORTTASKS_IDC		416002
#define VN_TR_TASKS_SUPPORTTASKS_CTRL		(VN_TR_TASKS_CTRL controlsGroupCtrl VN_TR_TASKS_SUPPORTTASKS_IDC)
#define VN_TR_TASKS_TASKTITLE_IDC			416003
#define VN_TR_TASKS_TASKTITLE_CTRL			(VN_TR_TASKS_CTRL controlsGroupCtrl VN_TR_TASKS_TASKTITLE_IDC)
#define VN_TR_TASKS_TASKDESCRIPTION_IDC		416004
#define VN_TR_TASKS_TASKDESCRIPTION_CTRL	(VN_TR_TASKS_CTRL controlsGroupCtrl VN_TR_TASKS_TASKDESCRIPTION_IDC)
#define VN_TR_TASKS_TASKDISTANCE_IDC		416005
#define VN_TR_TASKS_TASKDISTANCE_CTRL		(VN_TR_TASKS_CTRL controlsGroupCtrl VN_TR_TASKS_TASKDISTANCE_IDC)
#define VN_TR_TASKS_POLAROID_IDC			416006
#define VN_TR_TASKS_POLAROID_CTRL			(VN_TR_TASKS_CTRL controlsGroupCtrl VN_TR_TASKS_POLAROID_IDC)
#define VN_TR_TASKS_ZONEMAP_IDC				416007
#define VN_TR_TASKS_ZONEMAP_CTRL			(VN_TR_TASKS_CTRL controlsGroupCtrl VN_TR_TASKS_ZONEMAP_IDC)
